...
def HPlane_si3d_to_python(Plane, dx):
    ...
    for count in range(0, n_frames + 1):
        ...
        if st is False:
            ...
            if count == 0:
                ...
                la[:, count] = out_array[7:len(out_array):8]
            else:
                # ... GEOMETRY only in first step
                ...
                la[:, count] = out_array[5:len(out_array):6]
