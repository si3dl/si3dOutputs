...
# horizontal planes (H-Planes) and saves the data as matlab structures. The
# code is based of previous versions created by Alicia Cortes and others
# authors related to the use of this numerical model.

# Version 1:
# - This version transform the binary file result from SI3D into a
# python dictionary for each of the planes considered in the simulation.
# - This script also creates a DOY time variable as well as a DateTime
# variable for plotting purposes.

# NOTES: 1. The resulting structure will have 3D matrices where the third
# dimensions is for the time steps
...
def HPlane_Si3dToPython(Plane,dx,SimPath):
    os.chdir(SimPath)
